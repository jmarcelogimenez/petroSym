...
dicIntermedio['divSchemes']['div(phi,omega)'] = ['Gauss linearUpwind default']
dicIntermedio['divSchemes']['div(phi,k)'] = ['Gauss linearUpwind default']
...
dicAltoOrden['divSchemes']['div(phi,U)'] = ['Gauss linear']
